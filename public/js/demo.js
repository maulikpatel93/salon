...
(function ($) {
    ...
    function createSkinBlock(colors, callback, noneSelected) {
        var $block = $("<select />", {
            class: noneSelected
                ? "form-select mb-3 border-0"
                : "form-select mb-3 text-light border-0 " +
    ...
    var $navbar_variants_colors = createSkinBlock(
        ...
        function () {
            ...
            $(this)
                .parent()
                .removeClass()
                .addClass("form-select mb-3 text-light border-0 ");
    ...
    // $accent_variants.removeClass().addClass('form-select mb-3 text-light border-0 ').addClass(active_accent_color)
        ...
        function () {
            ...
            if (color) {
                $(this)
                    .parent()
                    .removeClass()
                    .addClass("form-select mb-3 border-0")
                    .addClass(color)
                    .addClass(
