...
@endphp
<select id="grid-filter-filters[{{ $name }}]" class="form-select grid-filter" name="filters[{{ $name }}]" role="grid-view-filter-item" form="grid_view_filters_form" onchange="if($(this).val()){$('#grid_view_filters_form').submit();}">
