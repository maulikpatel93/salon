...
$formRoute = !$model->id ? route('admin.salonpermissions.store') : route('admin.salonpermissions.update', ['id' => encode($model->id)]);
...
<div class="mb-3">
    {{ Form::label('salon_module_id') }}
    {{ Form::select('salon_module_id', $modules, $model->salon_module_id, [
        'class' => 'form-select select2',
        'id' => $formName . '-salon_module_id',
        'placeholder' => '',
    ]) }}
</div>
<div class="mb-3">
...
{!! JsValidator::formRequest('App\Http\Requests\Admin\SalonPermissionsRequest', '#gridview-form') !!}
